...
/******/ 	return __webpack_require__(__webpack_require__.s = "./themes/Schwarz/js/subnavigation.js");
/******/ })
/************************************************************************/
/******/ ({
...
var _init_subnavigation = function _init_subnavigation() {
  var navigationHistoryIdentifiers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  document.addEventListener('DOMContentLoaded', function () {
    var navigationSubmenuVisibleClassName = "header-navigation-submenu-visible";
    var hideClassName = "d-none";
    var header = document.querySelector('*[data-controller="header"]');

    if (!header) {
      return;
    }

    var headerNavigationContainer = header.querySelector("[data-controller=\"header/navigation\"]");
    var headerBackButton = header.querySelector("[data-controller=\"header/navigation/back\"]");
    ...
    var initializeNavigation = function initializeNavigation() {
      ...
      var headerNavigationHistory = _toConsumableArray(navigationHistoryIdentifiers);
...
var _default = _init_subnavigation;
exports["default"] = _default;
...
/***/ "./themes/Schwarz/js/subnavigation.js":
/*!********************************************!*\
  !*** ./themes/Schwarz/js/subnavigation.js ***!
  \********************************************/
/*! no static exports found */
...
var _subnavigation = _interopRequireDefault(__webpack_require__(/*! ../../../js/subnavigation */ "./js/subnavigation.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

(function () {
  return (0, _subnavigation["default"])();
})();
