...
/******/ 	return __webpack_require__(__webpack_require__.s = "./themes/Schwarz/js/header.js");
/******/ })
/************************************************************************/
/******/ ({
...
__webpack_require__(/*! ./cakeDOM */ "./js/cakeDOM.js");

var _themeSlider = _interopRequireDefault(__webpack_require__(/*! ./themeSlider */ "./js/themeSlider.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

var _init_header = function _init_header() {
  var closeMobileMenuBreakpoint = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 960;
  document.addEventListener('DOMContentLoaded', function () {
    ...
    headers.forEach(function (header) {
      ...
      var hasSubNavElement = !!header.querySelector(".header-subnavigation-list:not(.d-none)");
      ...
      var initSliders = function initSliders() {
        ...
        if (sliderMainNav === null) {
          ...
          sliderMainNav = new _themeSlider["default"](defaultSliderSettings, false, navigation, sliderMainNavList, sliderMainNavButtonPrevious, sliderMainNavButtonNext);
          sliderMainNav.initialize();
        }

        if (hasSubNavElement && sliderSecNav === null) {
          var sliderSecNavListEl = header.querySelector(".header-subnavigation-list:not(.d-none)");
          sliderSecNav = new _themeSlider["default"](defaultSliderSettings, false, navigation, sliderSecNavListEl, sliderSubNavButtonPrevious, sliderSubNavButtonNext);
...
var themeSlider = function () {
  function themeSlider() {
    ...
    var sliderWrapperEl = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document.querySelector('*[data-toggle="theme-slider"]');
    var sliderListEl = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var previousButtonEl = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    var nextButtonEl = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
    ...
    this.sliderConfig = _objectSpread({
  ...
  _createClass(themeSlider, [{
    ...
    get: function get() {
      var sliderInfo = this.info;
      if (!sliderInfo.isOn) return "disabled";
      if (sliderInfo.displayIndex === 1 && sliderInfo.slideCountNew - sliderInfo.slideBy <= 0) return "disabled";
      if (sliderInfo.index + sliderInfo.slideBy >= sliderInfo.slideCountNew) return "end";
      ...
      var positionDiff = (sliderRect.x || sliderRect.left) + sliderRect.width - ((themeSliderRect.x || themeSliderRect.left) + themeSliderRect.width);
      ...
      if ((sliderRect.x || sliderRect.left) + sliderRect.width <= (themeSliderRect.x || themeSliderRect.left) + themeSliderRect.width + this.sliderConfig.gutter) return "end";
      if (positionDiff < this.sliderConfig.gutter + 1 && positionDiff > 0) return "disabled";
      if (sliderInfo.displayIndex === 1) return "start";
      return "middle";
    }
  }, {
    key: "info",
    ...
    key: "initializeAllSliders",
    value: function initializeAllSliders() {
      var sliderConfig = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      document.addEventListener('DOMContentLoaded', function () {
        var themeSliderElements = document.querySelectorAll('*[data-toggle="theme-slider"]');
        themeSliderElements.forEach(function (themeSliderElement) {
          new themeSlider(_objectSpread({
            slideBy: 'page',
            gutter: 8,
            fixedWidth: 120,
            responsive: {
          ...
          }, sliderConfig), true, themeSliderElement);
        });
      });
    }
  }]);
...
var _header = _interopRequireDefault(__webpack_require__(/*! ../../../js/header */ "./js/header.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

(function () {
  return (0, _header["default"])();
})();
